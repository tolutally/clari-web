      ...
      <div className="bg-gradient-to-b from-[#f8fafc] to-white">
        <div className="max-w-4xl mx-auto px-6 py-16 space-y-12">
          ...
          <footer className="pt-6 border-t border-[#003366]/10 flex items-center justify-between text-sm">
            <a href="/placement-cost-calculator" className="text-[#003366]/60 hover:text-[#003366] transition-colors">
    ...
    <main className="min-h-screen">
      ...
      <div className="bg-gradient-to-b from-[#f8fafc] to-white">
        <div className="max-w-4xl mx-auto px-6 py-16 space-y-12">
          ...
          <footer className="pt-6 border-t border-[#003366]/10 flex items-center justify-between text-sm">
            <a href="/placement-cost-calculator" className="text-[#003366]/60 hover:text-[#003366] transition-colors">&larr; Back to Calculator</a>
            <p className="text-[#003366]/40 text-xs">Report generated {fmtDateTime(run.created_at)}</p>
          </footer>
        </div>
      </div>
