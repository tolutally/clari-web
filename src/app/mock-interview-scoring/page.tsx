...
export const metadata: Metadata = {
  title: "Mock Interview Scoring | Clarivue",
  description:
    "Learn how Clarivue's AI-powered mock interviews score learners on role-specific competencies, behavioral storytelling, and technical fluency.",
};

export default function MockInterviewScoringPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen pt-24 pb-16">
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="mt-4 text-lg text-[#003366]/60 max-w-2xl mx-auto">
            How AI-powered scoring detects interview readiness gaps before
            learners meet real employers — replacing guesswork with structured,
        ...
        <section className="max-w-3xl mx-auto px-4 sm:px-6 mt-16 space-y-8">
          <div className="rounded-2xl border border-[#003366]/10 bg-white p-8">
            ...
            <p className="text-[#003366]/60 leading-relaxed">
              Clarivue evaluates learners across role-specific competencies,
              behavioral storytelling structure (STAR method), technical fluency,
              and communication clarity — producing a readiness score that
              advisors can act on immediately.
            </p>
          </div>
          <div className="rounded-2xl border border-[#003366]/10 bg-white p-8">
            <h2 className="text-xl font-bold text-[#003366] mb-3">
            ...
            <p className="text-[#003366]/60 leading-relaxed">
              Without structured scoring, readiness becomes anecdotal. Advisors
              can&apos;t tell the difference between a learner who needs minor
              polish and one who will fail an employer interview — until
              it&apos;s too late.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-3xl mx-auto px-4 sm:px-6 mt-16 text-center">
          <div className="rounded-2xl bg-gradient-to-br from-[#0a2140] to-[#1a4060] p-10 text-white">
            <h2 className="text-2xl font-bold mb-3">See scoring in action</h2>
            <p className="text-white/70 mb-6">
              Book a demo to see how mock interview scoring works for your
              program.
            </p>
